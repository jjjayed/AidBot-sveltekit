...
const directoryLoader = new DirectoryLoader('/src/assets/support', {
...
const template =
	'Determine which of the sentences in the text require immediate attention and re-arrange them accordingly.\nText: {text}\nAnswer:';
